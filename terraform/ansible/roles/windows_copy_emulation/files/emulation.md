...
**Step 1**
```bash
[KALI:bash] xfreerdp3 /u:PurpleUser /p:SecurePwd123 /v:10.0.1.15 /cert:ignore
```
...
**Step 19**
```bash
[KALI:bash] xfreerdp3 /u:Administrator /p:'DomainPwned!' /d:ATTACKRANGE /v:10.0.1.16 /cert:ignore
```
ATT&CK Techniques: `T1021.001` `T1078`
